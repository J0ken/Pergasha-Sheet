// Namespace Pergasha5E Configuration Values
export const DND5E = {};
...
/* -------------------------------------------- */
/**
 * The set of psi limit
 * @type {Object}
 */
DND5E.psiLimit = ["0","1","2","3","4","5","6","7","8"];
  // DND5E.psiLimit ={
  //   "zero": "0",
  //   "one": "1",
  //   "two": "2",
...
DND5E.characterFlags = {
  ...
  "psiLimitBoost": {
    name: "Psi-Limit Boost",
    hint: "Your Psi-Limit is increased by 1.",
    section: "Feats",
    type: Boolean
  },
  "reliableTalent": {
